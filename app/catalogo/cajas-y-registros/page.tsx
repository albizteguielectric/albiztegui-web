...
// Sub-Pestañas de Filtrado para Cajas y Registros
const categoriasCajas = [
  { id: 'Todas', nombre: 'Todas' },
  { id: 'CAJAS METALICAS', nombre: 'Metálicas y Registros' },
  { id: 'PLASTICAS Y CANALETAS', nombre: 'Plásticas y Canaleta' },
  { id: 'INTERPERIE Y TIPO ZAPATO', nombre: 'Intemperie y Reforzadas' },
  { id: 'TAPAS Y COMPLEMENTOS', nombre: 'Tapas y Complementos' }
]
...
export default function CajasRegistrosPage() {
  ...
  useEffect(() => {
    ...
    const fetchProductos = async () => {
      // 1. Cargar catálogo de productos_cajas ordenados por CÓDIGO de menor a mayor
        ...
        <div className="mb-16">
          <div className="text-center max-w-2xl mx-auto mb-8">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-blue-900 mt-3">
              Gama Completa de Cajas y Registros
            </h2>
          ...
          {/* BARRA DE INFORMACIÓN DE REGISTROS Y PAGINACIÓN SUPERIOR */}
