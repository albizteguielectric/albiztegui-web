...
// 1. Componente interno que maneja la búsqueda y lee SearchParams
...
// 2. Componente Principal exportado por defecto con boundary de Suspense
export default function BuscarPage() {
  return (
    ...
    >
      <Suspense fallback={
        <div className="max-w-5xl mx-auto bg-white/90 p-8 rounded-2xl text-center">
          <p className="text-lg font-bold text-blue-900 animate-pulse">Cargando buscador...</p>
        </div>
      }>
        <ContenidoBuscar />
      </Suspense>
